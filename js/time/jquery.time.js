...
//		                    $('.df-box').width(tabWid+10)
		                    ...
		                    /*$('.df-box').width(wid/2.4);
		                    $('.df-box').css({"transform":"scale(2.4)"});
		                    var boxWidth = $('.df-box').width();
		                    var leftWidth = (wid-boxWidth)/2;
		                    $('.df-box').css({"margin-left":leftWidth});
		                    $('.df-btn').css({"height":".34rem","line-height":".34rem"});
		                    $(".df-final").css({"font-size":"24px","line-height":"2"});*/
		                   
		                   	var wrapWidth = $(".df-wrap").width();
		                   	var wrapHeight = $(".df-wrap").height();
		                   	var count = wrapWidth/wid;
		                   	var scales = wid*0.6/wrapWidth;
		                   	var marginTop = wrapHeight*(scales-1)/2;
		                   	$(".df-wrap").css({"transform":"scale("+scales+")","margin-top":marginTop+"px"});
		            ...
		            buildHTml:function(){
		                ...
		                if(sjObj.opt.alwaysShow){
		                  ...
		                  //  }
		                    	...
		                    	sjObj.opt.timeElm.append(sjObj.opt.t_box.append(sjObj.opt.df_btn).append(sjObj.opt.finalshow?sjObj.opt.df_final:"").append(main.append(wrap)));
		            ...
		            bindFun:function(){
		                ...
		                sjObj.opt.timeElm.find(".df-ok").on("click",function(){
		                    ...
		                    console.log(sjObj.opt.val);
		                    sjObj.opt.callback && sjObj.opt.callback(sjObj.opt.val);
		                    $(this).parent().parent().parent().remove();
